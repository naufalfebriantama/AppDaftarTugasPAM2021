package com.naufal.appcrud.ui.main
...
import com.naufal.appcrud.R
import com.naufal.appcrud.db.note.NoteDao
import com.naufal.appcrud.db.note.NoteRoomDatabase
...
class EditActivity : AppCompatActivity() {
    ...
    private fun saveNote(note: Note){
        ...
        Toast.makeText(applicationContext, "Activity saved", Toast.LENGTH_SHORT).show()

    }

    private fun deleteNote(note: Note){
        dao.delete(note)
        Toast.makeText(applicationContext, "Activity removed", Toast.LENGTH_SHORT).show()
    }
}
